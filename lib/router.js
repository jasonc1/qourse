...
questionGroup.route('/:_id#responses', {
  name: 'responsesOnQuestionPage', 
  action: function() {
    BlazeLayout.render('layout', {content: 'questionItem'});
  }
});
...
searchGroup.route('/', {
  name: 'searchPage',
  action: function() {
    console.log("hi I'm in this route");
    BlazeLayout.render('layout', {content: 'search'});
  }
});

searchGroup.route('/:searchParam', {
  name: 'searchSpecific', 
  action: function() {
